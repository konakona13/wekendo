...
<body class="animsition">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<c:if test="${memAuth.id == null}">
						<a href="loginmain" class="flex-c-m trans-04 p-lr-25">회원가입 / 로그인</a>
						</c:if>
						
						<c:if test="${memAuth.id != null}">
						<a href="Logout1" class="flex-c-m trans-04 p-lr-25">로그아웃</a>  
						<a href="loginmain" class="flex-c-m trans-04 p-lr-25">마이페이지</a>
						<a href="#" id = "sendBoxList" class="flex-c-m trans-04 p-lr-25">쪽지함</a> 
						</c:if> 
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1"><p align = "center"><img src="kimView/images/main_event1.jpg" width="1150" alt="IMG-LOGO"></p>
				...
				<div class="item-slick1"><p align = "center"><img src="kimView/images/main_event2.jpg" width="1150" alt="IMG-LOGO"></p>
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="kimView/images/product_banner_02.png" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="kimView/images/product_banner_03.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="kimView/images/product_banner_02.jpg" alt="IMG-BANNER">

						<a href="product.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8" style ="color:white; ">
									'나 혼자 산다' <br/>헨리가 카약 탄 그 곳!
								</span>
...
<!-- 
  <div class="container">
        	...
        	<tr>
				...
				<img src="HHHview/doIMG/${kendoJoin.doImg.doImgName}"  width="300" height="200"><br/>
				</c:if>
				<br/>
				${kendoJoin.doNum}<br/>  
